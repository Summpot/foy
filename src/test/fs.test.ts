...
describe('fs', () => {
  ...
  it('symlink rmrf', async () => {
    ...
    assert.ok(await fs.exists(`${symlinkDir}/file1`), 'await fs.exists(`${symlinkDir}/file1`)')
    assert.ok(!(await fs.exists(`${symlinkDir}/link1`)), 'await fs.exists(`${symlinkDir}/link1`)')

    await fs.symlink(`${symlinkDir}/dir1`, `${symlinkDir}/linkdir1`)
    await fs.rmrf(`${symlinkDir}/linkdir1`)
    assert.ok(await fs.exists(`${symlinkDir}/dir1`), 'await fs.exists(`${symlinkDir}/dir1`)')
    assert.ok(
