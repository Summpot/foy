...
function appendCallback<Fn extends (...args) => void | Promise<void>>(
	name: ListenerNames,
	fn: Fn,
) {
...
export const before = (fn: (t: Task) => void | Promise<void>) =>
	appendCallback("before", fn);
export const after = (fn: (t: Task) => void | Promise<void>) =>
	appendCallback("after", fn);
